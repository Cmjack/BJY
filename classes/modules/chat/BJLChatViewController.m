...
- (void)setupSubviews {
    ...
    [self.chatStatusView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.view.bjlmas_safeAreaLayoutGuide ?: self.view).offset(10.0);
        make.left.equalTo(self.view.bjlmas_safeAreaLayoutGuide ?: self.view).offset(-18.0);
        make.right.lessThanOrEqualTo(self.view.bjlmas_safeAreaLayoutGuide ?: self.view);
    ...
    [self.chatStatusLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.view.bjlmas_safeAreaLayoutGuide ?: self.view).offset(margin);
        make.centerY.equalTo(self.chatStatusView);
    ...
    [self.tableView mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.bottom.right.equalTo(self.view.bjlmas_safeAreaLayoutGuide ?: self.view);
    }];
