...
- (void)makeConstraints {
    ...
    [self.textView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self.contentView.bjlmas_safeAreaLayoutGuide ?: self.contentView).with.offset(-BJLViewSpaceM);
    ...
    [self.imageButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.contentView.bjlmas_safeAreaLayoutGuide ?: self.contentView).with.offset(BJLViewSpaceS);
