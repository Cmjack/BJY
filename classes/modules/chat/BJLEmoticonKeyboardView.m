    ...
    if (self = [super initWithFrame:CGRectZero]) {
        ...
        self.collectionView = ({
            ...
            [collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.right.top.equalTo(self.bjlmas_safeAreaLayoutGuide ?: self);
        ...
        self.pageControl = ({
            ...
            [pageControl mas_makeConstraints:^(MASConstraintMaker *make) {
                make.centerX.equalTo(self.bjlmas_safeAreaLayoutGuide ?: self);
                make.bottom.equalTo(self.bjlmas_safeAreaLayoutGuide ?: self).with.offset(- BJLViewSpaceS);
