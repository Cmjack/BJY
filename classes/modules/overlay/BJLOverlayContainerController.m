...
- (void)makeConstraints {
    ...
    [self.headerContainerView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        if (self.view.bjlmas_safeAreaLayoutGuideTop) {
            make.bottom.greaterThanOrEqualTo(self.view.bjlmas_safeAreaLayoutGuideTop).offset(0.0); // to be update
        }
        else {
    ...
    [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.headerContainerView.bjlmas_safeAreaLayoutGuide ?: self.headerContainerView).with.offset(BJLViewSpaceL);
        make.top.bottom.equalTo(self.headerContainerView.bjlmas_safeAreaLayoutGuide ?: self.headerContainerView);
    }];
    ...
    [self.buttonsStackView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.top.bottom.equalTo(self.headerContainerView.bjlmas_safeAreaLayoutGuide ?: self.headerContainerView);
    }];
}
...
- (void)updateHeaderViewConstraints {
    ...
    [self.headerContainerView mas_updateConstraints:^(MASConstraintMaker *make) {
        if (self.view.bjlmas_safeAreaLayoutGuideTop) {
            make.bottom.greaterThanOrEqualTo(self.view.bjlmas_safeAreaLayoutGuideTop).offset(headerHeight); // to be update
        }
        else {
...
- (void)updateFooterView:(nullable UIView *)footerView {
    ...
    if (footerView) {
        ...
        [footerView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.edges.equalTo(self.footerContainerView.bjlmas_safeAreaLayoutGuide ?: self.footerContainerView);
        }];
    }
